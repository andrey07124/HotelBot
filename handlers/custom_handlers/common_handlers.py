...
def get_hotels_quantity(message: Message) -> None:
    """Функция-хендлер. Ловит сщстояние hotels_quantity, записывает его значение из сообщения пользователя"""
...
def get_photo_quantity(message: Message) -> None:
    """Функция-хендлер. Ловит сщстояние photo_quantity, записывает количество фото из сообщения пользователя"""
